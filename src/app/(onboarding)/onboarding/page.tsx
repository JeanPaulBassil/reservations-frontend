...
export default function OnboardingPage() {
  ...
  }, [shouldRedirectToLogin, shouldRedirectToAdmin, shouldRedirectToDashboard, router, redirectAttempts]);
  ...
  }, [user, userRole, isInitializing, refreshUserData]);

  if (isInitializing || isLoading || shouldRedirectToLogin || shouldRedirectToAdmin || shouldRedirectToDashboard) {
    return (
