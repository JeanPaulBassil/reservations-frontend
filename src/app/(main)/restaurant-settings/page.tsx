...
export default function RestaurantSettingsPage() {
  ...
  const { isOpen: isUnsavedChangesModalOpen, onOpen: onOpenUnsavedChangesModal, onClose: onCloseUnsavedChangesModal } = useDisclosure();
                ...
                <div className="flex flex-wrap items-center gap-2 mt-1">
                  ...
                  <Chip size="sm" color="default" variant="flat">
                    <div className="flex items-center gap-1">
                      ...
                      <span>Created {new Date(currentRestaurant.createdAt).toLocaleDateString()}</span>
                    </div>
                  </Chip>
                  <Chip size="sm" color="success" variant="flat">
                    <div className="flex items-center gap-1">
                      <Icon icon="solar:refresh-circle-bold-duotone" className="w-3.5 h-3.5" />
                      <span>Updated {new Date(currentRestaurant.updatedAt).toLocaleDateString()}</span>
                    </div>
                  </Chip>
                </div>
              </div>
