...
import { useShifts, useCreateShift, useUpdateShift, useDeleteShift, toggleShiftActiveDirectly, updateShiftDirectly } from '@/hooks/useShift';
...
export default function ShiftsPage() {
  ...
  // Create update mutation with the selected shift ID
  const updateShiftMutation = useUpdateShift(selectedShift?.id || '', restaurantId);
        ...
        {selectedTab === 'upcoming' && (
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(groupedUpcomingShifts).map(([date, dayShifts], index) => {
