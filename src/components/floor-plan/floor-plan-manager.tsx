...
import { useTables, useCreateTable, useUpdateTable, useDeleteTable, useUpdateTablePosition, useUpdateTableStatus, useMergeTables, useUnmergeTables, tableKeys } from '@/hooks/useTable'
...
export default function FloorPlanManager({ restaurantId }: FloorPlanManagerProps) {
  ...
  const createTableMutation = useCreateTable(restaurantId, activeFloorId)
